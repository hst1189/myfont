...
1.  Appストアから、[AnyFont](https://apps.apple.com/jp/app/anyfont/id821560738)（App内課金有り）をインストール。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
源真ゴシックの等幅Lightをベースに、画数の少ない俗字・画数の少ない異体字などに変更した略字フォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
Fontworksの「レゲエ One」がSILライセンスで公開され、それをベースに一部の漢字を略字にしたフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「Rounded Mgen+」をベースに一部の漢字を略字にしたフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「おらだのみなもとの」をベースに一部の漢字を大正期の主に書物に載っている略字等に変更したフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
複数行のテキストの読みやすさと美しさを考慮し、ひらがな・カタカナの幅を少し狭くしたゴシック体。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
フリーフォントのダウンロードは、サイドバーの「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ひみこのクセが染み出るフォント。「ひこみフォント」とThinバージョンの「真・ひこみフォント」がダウンロードできます。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
見た目が似ていて間違いやすい文字・見た目が同じだが違う文字を判別しやすくするフォント。  
フリーフォントのダウンロードは、ページ上部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
画面での見やすさと適度な情報密度の両立を目指した日本語フォントで、その高い視認性と豊富なウェイトはWebサイトやスライドなどのビジネスシーンにぴったり。  
フリーフォントのダウンロードは、ページ上部の「Code- Download Zip」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
[M+1c Thin](http://mplus-fonts.osdn.jp/)の縦画を太くし、明朝体のようなアクセントを含んだ、クリアで明るくスマートなフォント。  
漢字は、すべてのJIS第一水準と一部の第二水準・IBM拡張を含んでいます。  
フリーフォントのダウンロードは、ページ下部の「フォントをダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
Adobeによる、こちらはコードが見やすいようデザインされたフォント。  
フリーフォントのダウンロードは、ページ上部の「Code- Download Zip」から。  
2020/11: macOS11の不具合に対応
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
Source Han SansとSource Code Proから派生したSource Han Monoは、7種類のウェイトが揃ったプログラミング向けの等幅フォントです。「令和」の合字も縦・横が含まれています。  
フリーフォントのダウンロードは、ページ上部の「Code- Download Zip」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
MORISAWA BIZ UDゴシックを使用したプログラミング用合成フォント。基本は[JetBrains Mono](https://www.jetbrains.com/ja-jp/lp/mono/)との合成ですが、リガチャ版、スラッシュ付きゼロ版、Nerd Fonts対応版、英数字幅広版など、さまざまなバージョンがあり、2022/4にv.1.0.0としてメジャーバージョンがリリースされています。  
フリーフォントのダウンロードは[Releases](https://github.com/yuru7/udev-gothic/releases)から各版がダウンロードできます。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
プログラミング向け英文フォント「Hack」と、源ノ角ゴシックの派生フォント「源柔ゴシック」を合成したプログラミングフォント。  
フリーフォントのダウンロードは[Releases](https://github.com/yuru7/HackGen/releases)から各版がダウンロードできます。  
2023/5: v2.9.0にアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
IBM Plex MonoとIBM Plex Sans JPを合成した日本語プログラミングフォント。ThinからBoldまで、8種類のウェイトが揃っています。全角スペースが可視化されています。  
フリーフォントのダウンロードは[Releases](https://github.com/yuru7/PlemolJP/releases)から各版がダウンロードできます。  
2024/2: v1.7.1にアップデート。v2開発中。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
Windowsでも綺麗に、可読性・視認性・判読性が高い日本語プログラミング用フォント。  
フリーフォントのダウンロードは、ページ上部の「Code- Download Zip」から。  
2022/3: v5.0.3にアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
源暎エムゴをエディタで使いやすく、読みやすい等幅フォントに組み替えた書体。モノコードはスラッシュゼロ搭載。  
フリーフォントのダウンロードは、ページ上部の「ダウンロードはこちら」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
フォントのサイズやバランスを欧文フォントに合わせたUI用のフォント。  
フリーフォントのダウンロードは、ページ上部の「Code- Download Zip」から。  
2020/11: 日本語のreadmeを追加
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
日本語フォントの表示で悩みの一つが、約物の幅が広いこと。Yaku Han JPは、Webテキストの日本語に含まれる約物を半角にする約物半角専用のWebフォントです。  
フリーフォントのダウンロードは、ページ上部の「Download」から。  
2023/9: v.4からベースをGoogleフォント版に変更。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
癖のないデザインで使いやすい丸ゴシックフォント。収録漢字はJIS第1～4水準すべてを含む約14000文字以上、縦書きにも対応しています。また、ウェイトは極細から極太まで7種類、丸さも3種類、ひらがなと漢字のバランスを変えた2種類、英数字の形状が異なる4種類、さまざまなデザインにマッチします。  
書体が多すぎて迷う時は、丸さの強弱でノーマルかLかXを選び、1cで7種類のウェイトをインストールしてみてください。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
角ゴシックの「[M+ Font](http://mplus-fonts.sourceforge.jp/)」を丸ゴシックにしたフォント。Regular, BoldだけでなくThin, Heavyなど7つのウエイトが揃っているのも魅力です。  
漢字は、JIS第一・第二（4,800字）水準。  
フリーフォントのダウンロードは、ページ上部の「ダウンロード」をクリックして、移動したページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
源ノ明朝を角丸にし、丸ゴシックにしたフォント。.ttf形式なのでWordやPowerPointでも利用できます。  
フリーフォントのダウンロードは、ページ上部の「Code- Download Zip」から。
...
個人サイトで無料利用可。同人誌や各種印刷物なども可。  
やさしい雰囲気で、キモチが楽しくなるような使いやすいゴシック体。有料版もあります。  
フリーフォントのダウンロードは、ページ下部の「無料ダウンロード」から。
...
個人サイトで無料利用可。同人誌や各種印刷物なども可。  
2本線が印象的なデザインで、ポップでどこか懐かしい丸ゴシック体フォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人サイトで無料利用可。同人誌や各種印刷物なども可。  
モダンとレトロがブレンドされた、流れるような自由なラインの角ゴシック体。有料版は縦書き対応・別字形も収録されています。  
フリーフォントのダウンロードは、ページ最下部の「Download」から。
...
丸亀城のある、風光明媚な丸亀市をイメージした可愛い丸ゴシック体のフォント。  
フリーフォントのダウンロードは、ページ下部の「無料ダウンロード」から。
...
白鷺城をイメージした丸ゴシック体。和のデザインや女性らしさを演出する時にぴったりで、スピード感のある線の軽やかな流れが特徴です。  
フリーフォントのダウンロードは、ページ下部の「無料ダウンロード」から。
...
個人で無料利用可。画像投稿サイト、コミケなどの同人誌の利用も無料。  
熊本城をイメージした丸ゴシック体。文字のところどころに切れ目がある面白いデザインで、少しユーモア感のある動きが特徴です。  
フリーフォントのダウンロードは、ページ下部の「無料ダウンロード」から。
...
個人で無料利用可。画像投稿サイト、コミケなどの同人誌の利用も無料。  
彦根城をイメージした丸ゴシック体。城の特徴である迷路のような通路をイメージした遊び心のデザインです。  
フリーフォントのダウンロードは、ページ下部の「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
丸ゴシック系の漢字に明朝体風のウロコの付いたかな文字を組み合わせたアンティーク体のフォント。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
漢字はSF風に、かなは古風にデザインされた不思議なフォント。和田研細丸ゴシックの派生で、近未来と古典が融合されたデザインです。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
※サイト閉鎖、[web.archive.org](http://web.archive.org/web/20170425180713/http://plaza3.dws.ne.jp/~m.okubo/sub1.html)からダウンロードはできます。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
Adobeによる5番目のオープンソースフォントで、日本語・簡体中国語、繁体中国語、韓国語の東アジアで用いられている４つの言語に対応したセリフ体。65,535の字形に、ExtraLight, Light, Normal, Regular, Medium, Bold, Heavy の7つのウェイトが揃っています。  
Typekit経由で利用: [源ノ明朝 -Typekit](https://fonts.adobe.com/fonts/source-han-serif-japanese)  
フリーフォントのダウンロードは、ページ上部の「Code- Download Zip」から。  
2023/8: v.2.002にアップデート
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
築地初号やそこから派生した明朝体を参考に作られたかなフォント。表情が豊かな字形は見出しにぴったりなオールドスタイルのデザインです。一部の文字は旧字形も使用できます。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
築地五号系の伝統的な本文向け明朝体を意識して作られたかなフォント。独特な字形は本文をはじめ、見出しやタイトルにもぴったりです。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
築地体を参考にした、やさしくてふんわりしたフォント。  
フリーフォントのダウンロードは、ページ最下部の「Download」から。  
2021/3: アップデート。文字のデザインがよりしなやかになりました。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
2,000文字以上の漢字を旧字化したフォント。桜や学や国など、画数の多い旧字で使用できます。  
フリーフォントのダウンロードは、ページちょい下「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ノスタルジックな雰囲気を持ちながら、普通の明朝体のような感覚で使うことができるフォント。  
フリーフォントのダウンロードは、フォント名の下「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
インクが滲んだようなレトロな雰囲気の明朝体。ロゴやタイトル、キャッチコピーなどにぴったりです。  
フリーフォントのダウンロードは、ページ下部の「フォントをダウンロードする」から。
...
同人誌のタイトルや小見出しへの使用を想定して作成されたフォント。普通の明朝体より筆の癖がおさえており、ハネが長く鋭くシャープな感じです。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ブランドやサービスのロゴで使われているようなモダンで、読みやすい文字をイメージして、デザインされたフォント。レトロな雰囲気と高級感があわさったデザインで、ロゴに使用しても、本文に使用しても、いけるフォントです。  
フリーフォントのダウンロードは、ページ下部の「フォントファイル」から。  
2021/2: ver.2にアップデート
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「コーポレート明朝」に強めのラウンド処理をかけ、全体的にしっとりとした雰囲気のフォント。  
フリーフォントのダウンロードは、ページ下部の「ダウンロードがこちら」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
やや癖のある柔らかな曲線のかなを収録したオールド系の明朝体フォント。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
源ノ明朝をさまざまなソフトウェアで利用できるようにTrueTyep化したフォント。  
フリーフォントのダウンロードは、ページ上部の「Code- Download Zip」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
源ノ明朝をやや縦長にし、角立てもして、温かく広がりがある雰囲気のフォント。.ttf形式なのでWordやPowerPointでも利用できます。  
フリーフォントのダウンロードは、ページ上部の「Code- Download Zip」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
文字がギザギザに揺れているインパクトのあるフォント。大きいサイズで移動している感、小さいサイズでチョークっぽい手描き感を楽しめます。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
源ノ明朝をベースに、勢いでプログラムを利用して作ったフォント。  
ひらがな・カタカナ・英数記号文字・漢字を収録。  
フリーフォントのダウンロードは、ページ下部の「無料ダウンロード」から。
...
個人で無料利用可、非営利の同人誌や各種印刷物なども可。  
大刀と強弓の女武者・巴御前をイメージした明朝体。  
ひらがな・カタカナ・英数記号文字・漢字は教育用漢字1006字を収録。  
フリーフォントのダウンロードは、ページ下部の「無料ダウンロード」から。
...
個人で無料利用可、非営利の同人誌や各種印刷物なども可。  
ひらがなは「白雪姫」、カタカナは「7人のドワーフ」、漢字は「王子様」、白雪姫の物語をイメージした明朝体。  
ひらがな・カタカナ・英数記号文字・漢字は教育用漢字1006字を収録。  
フリーフォントのダウンロードは、ページ下部の「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
源ノ明朝をベースに、横線を少し太く、縦線を少し細くした横太明朝体。  
フリーフォントのダウンロードは、ページ下部の「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
源ノ明朝・源ノ角ゴシックをベースに、異世界に転移した時の世界が歪むようにデザインされたフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
源ノ明朝をベースに、読める限界ギリギリまで破壊された世界観の見出し向け明朝体。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
源ノ明朝をベースに、横線が極細のステンシル体風の見出し向け明朝体。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ISO/IEC 10646およびUnicodeの全漢字9万字以上を収録、「渡辺」など同じ音でも異なる漢字が豊富に用意されています。  
フリーフォントのダウンロードは、ページ上部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「花園明朝」の作者様から久しぶりに新しいフォントがリリース。フォントに含まれているグリフはなんと、141,457字！ Unicode 15.1の追加にも対応しています。  
フリーフォントのダウンロードは、ページ上部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
フリーフォントのダウンロードは、サイドバーの「Downloads」から。
...
さわらびフォント  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
2019/10: アップデートされ、漢字が追加。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。

Google Fontsにも登場しました。  
[Sawarabi Mincho -Google Fonts](https://fonts.google.com/specimen/Sawarabi+Mincho), [Sawarabi Gothic -Google Fonts](https://fonts.google.com/specimen/Sawarabi+Gothic)
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
新聞明朝ふうの見出し向け、かなフォント。有料版はひらがなとカタカナ、お試し版はひらがなのみの収録。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
昭和初期の文部省の教科書活字にインスパイアされたフォント。骨格は踏襲しつつも教科書体という枠組みを外し、平安朝的で優美な書道的書体として改刻しました、とのことです。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
※2021/12: お試し版のダウンロード終了。
...
[Shippori Antique -Google Fonts](https://fonts.google.com/specimen/Shippori+Antique), [Shippori Antique B1 -Google Fonts](https://fonts.google.com/specimen/Shippori+Antique+B1)  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
しっぽりフォントシリーズ第2弾で、コミック・マンガのセリフや絵本の文に最適なフリーフォント。筆文字感のある正統派アンチック体は、縦書きでも非常に読みやすいデザインになっています。  
フリーフォントのダウンロードはページ上部の「Download Family」から、またはGitHubの「Code- Download Zip」から。  
2021/11: v2.001にアップデート。  
2022/4/10: 本サイトにてOTF版リリース。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
源ノ角ゴシックをベースにした、軟やかな仮名文字の特徴を残しつつ、ゴシック体の漢字との親和性を高めたアンチック書体。全体的にくっきり見えるようにデザインされており、にじみやすい印刷物にもお勧め。  
ひらがな・カタカナ・英数記号文字・漢字を収録。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
MORISAWA BIZ UDゴシックを使用したマンガや同人誌などのト書きや長いセリフにぴったりな、可読性に優れた合成フォント。「ComicStudio フォントパック」に収録されたアンチゴチ書体を再現したものです。  
フリーフォントのダウンロードは、「最新版」の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
エムゴの仮名と英数字を手書き風に作り直し、LINE Seed JPの漢字と組み合わせた、かわいいゴシック書体のフリーフォント。マンガや同人誌のセリフ、動画のテロップなどにぴったりです。  
フリーフォントのダウンロードは、ちょい下ダウンロードは「こちら」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
文字の縦書き、長文をターゲットに制作された本文用明朝体のフリーフォント。源ノ明朝をベースにしており、縦書きで読みやすくなるようひらがなを小振りに、漢字もすこし小振りにデザインされています。  
2019/10: v6.1にアップデート。  
フリーフォントのダウンロードは、ページ上部の「こちら」をクリックして、フォント名の下から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
マンガ向けに読みやすさを追求して制作されたフォント。ベースは源ノ角ゴシックで、ひらがな・カタカナと漢字のバランス調整、英数字も日本語に合うものに変更、マンガ向けの記号（怒りマークなど）を追加など、細かいこだわりがスゴイです。  
フリーフォントのダウンロードは、ページ上部の「こちら」をクリックして、フォント名の下から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
動画やゲームのテキスト表示やプレゼンテーションに使いやすいをコンセプトにした視認性に優れたゴシックフォント。特に、横組み・短文で見やすいようデザインされており、ゲームなどに同梱して配布・販売することもできます。  
フリーフォントのダウンロードは、ページ上部の「ダウンロードはこちら」から。  
2021/1/22: v2にアップデート、漢字数が約5,000文字から約14,000文字に。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
同人誌などで人気が高い源暎シリーズから、強調セリフやタイトルにぴったりな特太モダンゴシック体のフォント。マンガで見かける「あいうえお」に濁点、「ん」に濁点も利用できます。  
フリーフォントのダウンロードは、ページ上部の「こちら」をクリックして、フォント名の下から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ゴシック体のようで明朝体のようでもある特徴的な雰囲気のフォントで、ロゴやテロップにぴったりのスッキリとしたデザインです。  
フリーフォントのダウンロードは、ページ上部の「こちら」をクリックして、フォント名の下から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
書籍のノンブルで見かけるページ番号をデザインした数字フォント。  
フリーフォントのダウンロードは、フォント名の下から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
値札に表記する価格を想定した数字フォント。スーパーなどで見かける極太の数字をはじめ、価格表記に使われる漢字（円・個など）が利用できます。  
フリーフォントのダウンロードは、ページ中程の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
上記2つの同シリーズで、こちらはベーシックなフォント。源ノ角ゴシックをベースに、特別なソフトを使用しないでも読みやすいように、文字間やサイズの調整を行ったそうです。Pのプロポーショナルは文字詰め・サイズ調整、Nのノーマルはグリフ改変・サイズ調整、Mは等幅でコーディング時に最適なグリフに変更されています。  
フリーフォントのダウンロードは、ページ上部の「こちら」をクリックして、フォント名の下から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
マンガや同人誌のセリフ・キャッチコピーなどの短い文にインパクトがでるよう、ひらがなとカタカナを通常より5-7%大きくデザインしたフォント。  
普段使いにもかなり重宝するフォントです。マンガや同人誌向けの記号も多数収録されています。  
フリーフォントのダウンロードは、ページ上部の「こちら」をクリックして、フォント名の下から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
マンガに使用する効果音や描き文字をイメージした、オリジナルデザインのかな文字フォント。  
フリーフォントのダウンロードは、「Code」から「Download ZIP」をクリック。  
2020/11: 和文用約物のほぼ全てを追加。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
サイトで配布している効果音素材を元にした効果音フォント。カタカナと一部記号文字が揃っています。  
フリーフォントのダウンロードは、ページ下部「ダウンロードリンク」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ホラー用途に特化。マンガのネーム用として恐怖、恐喝、悪人などの恐ろしげなセリフの表現として使えるフォント。  
フリーフォントのダウンロードは、ページちょい下「DL」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
コミックホラーの太文字版として、悪役キャラや罵倒セリフに使えるようないやらしさ・嘲笑感・禍々しさを表現したフォント。  
フリーフォントのダウンロードは、ページちょい下「DL」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
コミックホラーに汎用性をもたせ、マンガのネーム用として使う事を主目的に読みやすさを重視したフォント。  
フリーフォントのダウンロードは、ページちょい下「DL」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
g\_コミック古印体の切り込み部分を削除し、線をなめらかにデザインしたフォント。  
漢字は収録されいないため、g\_コミック古印体と合わせてご利用ください。  
フリーフォントのダウンロードは、ページちょい下「DL」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
一見達筆でうまいっぽいけど、実はうまいのかへたなのか分からない味のある筆文字フォント。教育漢字と年賀状用の漢字が含まれています。  
フリーフォントのダウンロードは、ページちょい下「DL」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
マンガやイラスト、同人誌、ゲームなどでの手書き文字のシーンを演出できるフォント。  
フリーフォントのダウンロードは、ページちょい下「DL」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
イラストへの文字入れ、ロゴ等に使用する事を目的としてデザインされた太手書き角フォント。プレビュー版ですが、無料で利用できます。漢字は、小三漢字まで含まれています。  
フリーフォントのダウンロードは、ページちょい下「DL」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
g\_やぐらと同シリーズのこちらは丸文字フォント。文字の太さ等若干不揃いなのは仕様で、かわいいデザインです。プレビュー版ですが、無料で利用できます。漢字は、小三漢字まで含まれています。  
フリーフォントのダウンロードは、ページちょい下「DL」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ねこの丸み、しっぽ、すず、ひげ、爪などをイメージして作成された丸っこい独特の形がかわいいフォント。漢字は含まれていませんが、丸ゴシックと組み合わせるといい感じです。  
フリーフォントのダウンロードは、ページちょい下「DL」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
猫をモチーフにしたかわいいフォント。ねこもじを制作してから年数が経ち、技術的なサポートが難しくなりましたので、ねこもじは無料になりました。とのことです。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
三国志の登場人物や中二病漢字なども含まれています。  
フリーフォントのダウンロードは、サイドバーの「ぬかみそフォント」から。  
2020/7: アップデート、「ぬかみそ闇夜」フォントを同梱
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
フリーシェル「にしき」をイメージしたUnicode準拠のフォント。日本語をはじめ、さまざまな言語、音声記号や点字、絵文字も揃っています。  
フリーフォントのダウンロードは、ページ下部「フォントのダウンロード」から。  
2022/7: ver.3.90duにアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「デビルマンフォント」「タッチフォント」などをリリースしているWEBYANから、「コブラフォント」をリメイクして『スペースコブラ』のロゴを元に制作したフォント。カタカナ2書体・アルファベット・数字・記号・漢字126文字が揃っています。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
公開停止されていた初代ドカベンフォントが代理配布に。新ドカベンフォントもダウンロードできます。  
フリーフォントのダウンロードは、ページ下部の「ダウンロードはこちらから」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「デビルマンフォント」の作者から、にじさんじのロゴを元に制作したフォント。ひらがな・カタカナ・英数記号文字に漢字も少し収録されています。  
フリーフォントのダウンロードは、ページ下部の「ダウンロードはこちらから」から。  
2023/9: ライセンスがアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
COMPLEXのロゴにインスパイアされた英字フォント、「日本一心」も入力できます。デビルマンフォントでお馴染みの作者のフォントです。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
2023/9: ライセンスがアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
漫画・アニメ「タッチ」のロゴにインスパイアされたカタカナフォント。デビルマンフォントでお馴染みの作者がチキンタツタとタッチのコラボをみたときに、奮起して制作されたようです。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
2023/9: ライセンスがアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「スペースコブラ」の「コブラ」の部分にインスパイアされたフォント。既存のものとは少し異なります。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
2023/9: ライセンスがアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
映画「コマンドー」の日本版タイトルにインスパイアされたフォント。既存のものとは少し異なります。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
2023/9: ライセンスがアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「デビルマン」のタイトルにインスパイアされたフォント。既存のものとは少し異なります。おまけ文字も多数収録。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
2023/9: ライセンスがアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「バジリスク」のタイトルにインスパイアされたフォント。既存のものとは少し異なります。「バジリスク」に組まれた合字も収録。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
2023/9: ライセンスがアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「SIREN」の屍人が使用していた文字をフォント化。既存のものとは少し異なります。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
2023/9: ライセンスがアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ウマ娘のロゴ下「プリティーダービー」にインスパイアされて作成されたフォント。おまけ文字として、「うまむ」「ろ」もロゴが出せ、シルエットやスピード線や蹄鉄やURAなどもあります。  
フリーフォントのダウンロードは、ページ最下部の「ダウンロード」から。  
2023/9: ライセンスがアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
M+1pの「馬」を持つ漢字の「馬」をウマ娘仕様にしたフォント。ウマ娘の二次創作ガイドラインの範囲内でご使用ください。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
キルミーベイベーのロゴ風フォント、漢字は3,087文字収録。  
※以前公開していた「キルゴ」は現在公開中止。  
フリーフォントのダウンロードは、フォント名をクリックして、移動したページ「ダウンロード」から。
...
個人・商用サイトで無料利用可（商用は要連絡）。同人誌や各種印刷物なども可。  
きんいろモザイクのロゴ風フォント「きんいろサンセリフ」、キャッチ風フォント「こはるいろサンレイ」など、タイトルやキャッチにぴったりなフォント。  
フリーフォントのダウンロードは、フォント名をクリックして、移動したページ「ダウンロード」から。
...
アニメ「おそ松さん」のタイトルロゴをイメージしたフォント。  
※サイト閉鎖、[web.archive.org](https://web.archive.org/web/20220507122845/http://hachimitsudesign.com/download.html)からダウンロードはできます。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
アニメ「少女終末旅行」副題風フォント。漢字は、原作単行本6巻の副題・サウンドトラックの曲名・艦これの大部分・小学校二年生分まで。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「けものフレンズ」のロゴっぽくデザインされたフォント。ひらがな・カタカナ・数字・一部の記号文字と漢字が含まれており、あの「の」はくろまるで使用できます。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
丸くデザインされたおまけフォント「はらませにゃんこ まるみ」も付属しています。  
フリーフォントのダウンロードは、ページ下部の「だうんろーど」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ロマン溢れる冒険に飛び出したくなるような元気なフォント。マンガや同人誌のタイトルやロゴに、擬音・擬態語などにもぴったりです。  
フリーフォントのダウンロードは、ページ上部の「download」から。
...
個人で無料利用可、商用は有料。  
マンガや同人誌の擬音語・擬態語にぴったりのユニークな手書き風フォント。  
フリーフォントのダウンロードは、ページ下部の「フリーフォントをダウンロード」から。

## 日本語のフリーフォント: レトロ・アンティーク
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
2人組ユニット「涼鳩書林」から初のフリーフォント。レトロな雰囲気をもつ、令和生まれのなつかしいデザインのフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2023/9: ver.3.0にアップデート
...
明治30年の築地体前期五号仮名に基づき、アウトライン化されたフォント。活版印刷のレトロなデザインを楽しめます。  
フリーフォントのダウンロードは、ページ右端の「二〇一八年一月一日付版」から。  
2018/1: 戊戌アップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
明治から大正に実際に使われていた活字を手本とし、より正確な形を再現したフォント。「トキ」「トモ」「より」などの合略仮名も含まれています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
東京築地活版製造所の活版見本より、初號ひらがな・カタカナをフォント化。  
フリーフォントのダウンロードは、「Code」から「Download ZIP」をクリック。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
東京築地活版製造所の活版見本より、貮號ひらがな・カタカナをフォント化。  
フリーフォントのダウンロードは、「Code」から「Download ZIP」をクリック。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
東京築地活版製造所の活版見本より、三號ひらがな・カタカナをフォント化。  
フリーフォントのダウンロードは、「Code」から「Download ZIP」をクリック。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
東京築地活版製造所の活版見本より、四號ひらがな・カタカナをフォント化。  
フリーフォントのダウンロードは、「Code」から「Download ZIP」をクリック。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
東京築地活版製造所の活版見本より、五號活字をフォント化。漢字も少し含まれています。  
フリーフォントのダウンロードは、「Code」から「Download ZIP」をクリック。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
●と余白があるレトロチックなフォント。ひらがな・カタカナのみで、英数文字は有料版となっています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
フリーフォントのダウンロードは、ページ下部の「リリースページ」から。  
2019/8: v19.232にアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ロゴデザインにも利用できるフォント。シンプルでモダンな雰囲気が、昭和テイストのレトロなイメージです。  
フリーフォントのダウンロードは、ページ下部の「フォントファイル」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
少し太っちょ、縦長で、丸みを帯びたかわいいデザインのフォント。「コーポレート・ロゴ」の丸ゴシック版としてリリースされ、太っちょで丸みを帯びているため、優しい雰囲気、温かい雰囲気をだしたい時にぴったりです。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
明治時代の教科書を元に作成したひらがなフォント。ノーマルの「さくら」とにじみ加工された「いちょう」の2種類があります。明朝体や楷書体との混植がお勧めです。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
丸ゴシックながらどことなくレトロ感の漂う、使い勝手のよいフォント。ひらがなとカタカナが少しふにゃっとデザインされています。作者様おすすめのウェイトは、Mediumとのことです。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
古風な字形と、現代的なシャープさを合わせ持ったフォント。ExtraLight、Light、Regularはペン字のように太さが一定で、Medium、Boldは筆のように強弱のニュアンスがあります。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
いろはマルの漢字を自家製Rounded M+に置き換えたフォント。漢字がより正方形に近い形になり、ひらがなやカタカナとメリハリがついたデザインです。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人サイトで無料利用可。同人誌や各種印刷物なども可。  
1970年代のテレビテロップ文字からインスピレーションを得て再生したフォント。  
フリーフォントのダウンロードは、ページ下「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
角ゴシックの漢字に合わせたウロコの付きの文字を組み合わせたアンティーク体のフォント。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
その名の通り、フレンチブルドッグをイメージして作成されたかわいいフォント。無料のmini版は横書きのみですが、ひらがな・カタカナに加え、漢字も449文字が収録されています。  
フリーフォントのダウンロードは、ページ下部「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
作者の「やわらかドラゴン」をベースに制作された明朝系のデザインフォント。ひらがな・カタカナ・英数記号文字に加え、漢字も3459文字が収録されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人サイトで無料利用可。同人誌や各種印刷物なども可。  
手書き文字をベースにやんちゃな小僧をコンセプトに作成された元気系フォント。mini版では小学2年生までに習う漢字240文字が含まれています。  
フリーフォントのダウンロードは、ページ下部「Download」から。
...
個人サイトで無料利用可。同人誌や各種印刷物なども可。  
レトロなイメージやファンタジックなイメージを強調したい時に、ラックレター体を日本語の文字として解釈しなおしてデザインされたフォント。無料版はひらがな・カタカナ・漢字240文字が収録されています。  
フリーフォントのダウンロードは、ページ下部「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
力強く、でもどこか柔らかく優しさのある小さなドラゴンをイメージしたフォント。無料版はひらがな・カタカナ・漢字240文字が収録されています。  
フリーフォントのダウンロードは、ページ下部「Download」から。
...
パグ好きの人にぴったり、パグを記号化した時の部品を組み合わせてデザインされたフォント。無料版はひらがな・カタカナ・漢字80文字が収録されています。  
フリーフォントのダウンロードは、ページ下部「Download」から。
...
個人で無料利用可、同人活動に限り営利目的も可。  
小さくかわいい小鳥のイメージで作成されたフォント。見出しやコピーなどにぴったりで、デザインにかわいい雰囲気を演出します。無料版はひらがな・カタカナ・漢字80文字が収録されています。  
フリーフォントのダウンロードは、ページ下部「Download」から。
...
個人で無料利用可、同人活動に限り営利目的も可。  
小さくてコロコロしたひな鳥のような、少し真面目でかわいいフォント。無料版はひらがな・カタカナ・漢字80文字が収録されています。  
フリーフォントのダウンロードは、ページ下部「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
インパクトが欲しい時にぴったりな、強い骨格と微かな可愛らしさを合わせたフォント。ひらがな・カタカナ・英数記号文字、漢字3459文字が収録されています。  
フリーフォントのダウンロードは、ページ下部「Download」から。  
2020/8: plusにアップデート、漢字の文字数が増えて視差調整がされました。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
日本共産党風のゴシックフォント。  
フリーフォントのダウンロードは、ページ上部の「Download Font」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
程良いかすれが特徴的な手描きの明朝体フォント。第一水準漢字まで対応。投げ銭版には、濁点ひらがな・カタカナが収録されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
怪獣のツメのようにデザインされたフォント。無料版はカタカナと一部記号のみが収録されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
カリグラフィのペンで書いたような線に強弱があるかわいいフォント。スキップをしているような軽快なハネが特徴的です。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「全員集合！」80年代のテレビ番組で使用されたような手書き文字にインスパイアされた手書き文字フォント。ひらがな・カタカナ・英数記号文字のほか、常用漢字も使用できます。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人サイトで無料利用可。  
NHKで画面左上に表示される時刻表示にインスパイアされたフォント。「あったらいいな～」と思って制作されたそうです。0～9までの半角数字と半角コロンのみ収録されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
燃えさかる焔をイメージし、源ノ明朝をベースに炎の効果を施したフォント。極細から極太まで、7種類のウェイトが揃っています。  
※画像は、作者様の許諾を得て掲載しています。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
2023/9: アップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
同作者の焔明朝よりも炎感がバージョンアップされたフォント。漢字類はギリギリ潰れないような絶妙なバランスに仕上げられています。極細から極太まで、7種類のウェイトが揃っています。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
2023/9: アップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
美しい棘がある角ゴシック体。極細から極太まで、7種類のウェイトが揃っています。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
2023/9: アップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
こちらの棘は薔薇のような棘で、3種類のウェイトが揃っています。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
2023/9: アップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
普通に入力するだけでかっこいい旧字体や略字の漢字が使えるフォント。「風」の中がちょんちょんの略字、「工」の真ん中が曲がってる変形字体などもあります。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
2023/9: アップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
零式艦上戦闘機の機体プレートに使われていた文字を再現し、現代風にアレンジを加えたフォント。2016年に配布終了となっていましたが、漢字を加えて、再びダウンロードできるようになりました。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
2023/9: アップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
適度なポップさと飾り気のない直線を活かしたデザインフォント。同作者の旧マメロンのあのかわいい形が復刻されました。ひらがな・カタカナ・英数記号文字、漢字3000字程度となっていますが、第2水準まで対応予定です。復刻の経緯はページ下部にあり、なかなか興味深いです。  
フリーフォントのダウンロードは、ページ最下部の「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
佐藤大輔著「征途」の表紙にインスパイアされ、45°という角度に拘ってデザインされたフォント。ひらがな・カタカナ・英数記号文字のほか、漢字はJIS第一水準を含む4,500文字が揃っています。  
フリーフォントのダウンロードは、ページ最下部の「Download」から。  
2023/5: ver.2にアップデート、JIS第二水準漢字に対応。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
個人的にも特にお勧めの「マメロン」が、大きく変わりました。デジタルデバイスでの使用を意識してデザインされており、可読性が高いかわいいフォントです。収録文字はAdobeJapan1-3StdNに対応しており、JIS第一・第二水準漢字も揃っています。さらに、ウェイトが4種類も用意され、さまざまなデザインで楽しめます。  
フリーフォントのダウンロードは、ページ最下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「廻想体ネクスト」をさらに改良、漢字収録が前作よりも増えています。3種類の線だけで構成されたフォントで、漢字によってはタレ、ハネ、払いが異なるデザインも複数用意されています。  
フリーフォントのダウンロードは、ページ最下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
トガリテも変わりました。Thinが追加され、角もより尖り、濁点も尖ってます！  
フランス語で平等を意味する「égalitéリガリテ」と「尖る」という言葉から「トガリテ（togalité）」と名付けられたフォント。6ウェイトが揃っており、漢字は、JIS第一（2,965字）・第二（2,257字）水準ほか、約6,000文字を収録。  
フリーフォントのダウンロードは、ページ最下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
字を丁寧に書こうとした際のより線を真直ぐに引こうとした感じを表現したフォント。  
漢字はAdobeJapan 1-3、9354字に対応。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
上記のFlatが標準で、Squareは補完的なものです。  
漢字は、JIS第一（2,965字）・第二（3,390字）水準。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
かわいいの波及を追い求めて作成された「ポプらむ☆キュート」  
通称ブリッコ文字・マンガ文字と呼ばれた昭和時代の女子校生に流行ったコミカルな変体のまる文字で、現代風のテイストを入れつつ、デジタル用にアレンジしてデザインされています。  
ひらがな・カタカナ・英数記号文字だけでなく、JIS第1水準漢字2,965字、JIS第2水準漢字260字も収録。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
森川龍文堂カナモジ活字のカタカナを参考に、直線をいかしたデザインが特徴的なフォント。  
漢字は、JIS第一（2,965字）・第二（470字）水準。  
2018/4/27にバージョンアップされ、漢字が増えました。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
廻想体ネクストBをベースに、角を丸くしたスピンオフ・フォント。作者様が「あぁ、ホントは『丸い方』を所望なんだろうな。」とモヤモヤしたのを解消するために制作されたそうです。ひらがな・カタカナ・英数記号文字をはじめ、JIS第1水準漢字2,965字、JIS第2水準漢字486字を収録。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
学生さんが進級制作として作成したものをフリーフォントとして配布。ひらがな・カタカナ・英数記号文字・漢字が約1300文字が揃っています。  
フリーフォントのダウンロードは、ページちょい下の「ダウンロード」から。
...
個人・商用サイトで無料利用可（商用は要連絡）。同人誌や各種印刷物なども可。  
算数・数学で使用される図式の記号を取り入れてデザインされたフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2020/5: ver.1.4にアップデート。
...
個人・商用サイトで無料利用可（商用は要連絡）。同人誌や各種印刷物なども可。  
人気がある「数式フォント」の難解バージョン。こちらは、ひらがな・カタカナ・アルファベット・一部記号文字のみとなっています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
麦に寄生する麦角をモチーフにデザインされたフォント。毒々しさと素朴さの表現に向いています。ダウンロードは、最下部の「ダウンロード」から。  
ひらがな・カタカナ・数記号文字を収録。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「魔法少女まどか☆マギカthe film」のロゴをベースにした書体。  
ひらがな・カタカナ・英数記号文字・漢字  
漢字は、JIS第一・第二水準ほか、約6,000文字を収録。  
フリーフォントのダウンロードは、ページ上部の「download font」から。  
2021/5: ヘブライ語に対応。  
2021/6: 漢字追加、いくつかの字形を修正。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
スナップエンドウをモチーフにしたPOP用のフォント。販促基本漢字全96字+αの漢字が収録されています。  
フリーフォントのダウンロードは、ページ下部の「配布」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
でこぼこ感がかわいい、すこしレトロな雰囲気もあるフォント。ひらがな・カタカナ・英数記号文字に加え、1000文字の漢字が揃っています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「こころ明朝」「はんなり明朝」をリリースしているTyping Artからの新作フォント。鉄道っぽくて、メカっぽい、作字要素が盛り込まれたかわいフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「海と山のろごごち」「藍と白のゆきぐに」に続く、ロゴタイプみたいなかわいいフォントです。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人サイトで無料利用可。  
ロゴタイプみたいなゴシック体で、太めの文字がかわいいフォントです。フリー版では、ひらがな・漢字6文字が収録されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人サイトで無料利用可。  
ロゴタイプみたいなゴシック体で、カクカクした文字がかわいいフォントです。フリー版では、ひらがな・カタカナ・漢字3文字が収録されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
Cheekふぉんと  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
子供が書いたようなかわいい手書き風フォント。JIS第一水準の漢字2965文字に対応。  
※サイト閉鎖、[web.archive.org](https://web.archive.org/web/20220210075135/https://nonty.net/font/freefont/cheek-font//)からダウンロードはできます。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
しろくまの肉球をイメージした手書きフォント。一文字ずつみるとばらばらに見えますが、単語にするとまとまりがある趣のあるフォントです。  
ひらがな、カタカナ、英数記号文字、漢字を含む全659文字。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
黒薔薇シンデレラにトゲトゲ加工を施したフォント。長体は控えめで、7種類のウェイトによってトゲトゲ感が異なります。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
幾何学柄がパッチワークのように継ぎ接ぎされたフォント。投げ銭版には少しだけおまけ文字が含まれています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ミウラFONTのシリーズでおなじみの「グシャグシャ消した記号文字」が利用できます。サイトのリニューアルに伴い、フォントもアップデートされています。  
フリーフォントのダウンロードは、フォント一覧から「ミウラLinerOtf Jr R」を選択して、下部の「ダウンロードはこちら」をクリック。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「ミウラゴチック プロポ」を使ってみたい人用に、小３程度の漢字まで含まれたフリーフォント。有料版はJIS第一・第二水準が含まれています。  
フリーフォントのダウンロードは、フォント一覧から「ミウラゴチック プロポ Jr R」を選択して、下部の「ダウンロードはこちら」をクリック。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
シャープの古いロゴをもとにしたフォント。漢字は「松下電器産業株式会社」「東芝」など。混植用漢字だけのフォント「漢字堂電機店」もあります。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から  
2022/10: ver.3にアップデート
...
チェックポイント  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ウルトラクイズ風・和文総合書体。JIS第一/第二水準6,355字＋IBM拡張文字＋日本漢字能力検定1級配当漢字を収録。  
2022/2: アップデート。  
2022/3: サイトでの配布が終了し、再配布が可のため、当方で二次配布させていただきます。

*   [チェックポイント TTF](https://coliss.com/?smd_process_download=1&download_id=43052) (1.8MB)
*   [チェックポイント OTF](https://coliss.com/?smd_process_download=1&download_id=43055) (2.3MB)
...
チェックポイント★リベンジ  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「チェックポイントフォント」をベースに、より洗練されたデザインへと昇華させるべく、ほぼ全ての文字/記号を一から作り直し（＝リベンジ）たフォント。  
ウルトラクイズ風の和文総合書体「CPフォント」をより洗練されたデザインへと昇華させたフォント。  
2022/2: アップデート。  
2022/3: サイトでの配布が終了し、再配布が可のため、当方で二次配布させていただきます。

*   [チェックポイント★リベンジ TTF](https://coliss.com/?smd_process_download=1&download_id=43057) (1.3MB)
*   [チェックポイント★リベンジ OTF](https://coliss.com/?smd_process_download=1&download_id=43058) (1.2MB)
...
チェックポイント．（ピリオド）  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「チェックポイント」をベースに、ビットマップ風にデザインされたフォント。チェックポイントフォントシリーズの最終作としてリリースされた集大成的なフォントです。漢字もJIS第1水準漢字2,965字に加え、人名用漢字、JIS第2水準漢字の使用頻度が高い漢字が計4,200字含まれています。  
2021/4: アップデート。  
2022/3: サイトでの配布が終了し、再配布が可のため、当方で二次配布させていただきます。

*   [チェックポイント．（ピリオド） TTF](https://coliss.com/?smd_process_download=1&download_id=43059) (589KB)
*   [チェックポイント．（ピリオド） OTF](https://coliss.com/?smd_process_download=1&download_id=43060) (335KB)
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ゴシック体で太いフォントだと重くなりすぎるイメージを軽快でPOPに表現することができるようにハーフトーンにした極太フォント。背景が絶妙に透けて見えるので、1色づかいでもうっすらとグラデーションのように見えます。  
フリーフォントのダウンロードは、ページ最下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
雲のようにもくもくしすぎたフォント。もくもくのラインは非常に細く、小さいサイズで使用すると、また違った印象を与えます。  
フリーフォントのダウンロードは、ページ最下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
細めのサインペンで書いたような日本語フォント。第一水準漢字対応。  
フリーフォントのダウンロードは、ページ中程の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ふんわりとしたかわいいフォント。ひらがな・カタカナ・英数記号文字対応。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
まるっかなフォントの角を丸めたフォント。ひらがな・カタカナ・数記号文字が揃っています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「うたミン」フォントの作者から、「雪ファンテール」を元により元気な感じを出したフォント。ハライ部分がラッパの形をした小悪魔チックなデザインです。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
歌う文字というコンセプトのもとにつくられた音符のようなエレメントが文字のあちこちにちりばめられたフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2019/4: 新元号に対応。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「うたミン」の派生で、雪をモチーフにしたかわいいフォント。有料版は縦書き対応、無料版は横書きのみとなっています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
うたミンフォントの骨格を元にしたファンテール体のかなフォント。有料版は縦書き対応、無料版は横書きのみとなっています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2020/10/21: 漢字がいくつか追加されました。
...
個人サイトで無料利用可。非営利の同人誌や各種印刷物なども可。  
デジタル時計みたいなセグメントで構成されたフォント。英数記号文字だけでなく、ひらがな・カタカナも含まれています。一部の漢字も使用できます。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ニコニコ動画:GINZAのロゴをヒントにしたフォント。  
フリーフォントのダウンロードは、フォント名の横「詳細ページへ」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
角ゴシックを独特のフォルムで少しかわいくデザインしたフォント。  
フリーフォントのダウンロードは、フォント名の横「詳細ページへ」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ニコ角＋フォントの仮名文字をかわいいポップなデザインにアレンジ。  
フリーフォントのダウンロードは、フォント名の横「詳細ページへ」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
お祭りの楽しさをモチーフにしており、法被が上下左右に揺れるさまにインスパイアされたはちゃめちゃで楽しいフォント。文字を普通に配置するだけで、動いているように見えます。  
フリーフォントのダウンロードは、ページ最下部の「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
タイプデザイナー金井和夫氏の普段使いの文字をベースとした、明朝・行書・楷書の複雑なフォルムをもつフォント。オールドなイメージを残しつつも、近代的な組版にも対応するマルチな性格を備えています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
かすかに筆文字の名残り、味わいのある丸もじフォント。他のデザイン書体との相性もよく、既存の他社丸ゴシックと組み合わせても違和感なく溶け込み、あたたかな雰囲気を醸し出します。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
音楽を文字で表現した、かわいいと評判のフォント。  
※今までは個人のみ無料でしたが、商用も無料になりました。  
フリーフォントのダウンロードは、フォント名の下「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ゴシックでありながら和の雰囲気、清潔さを兼ね備えた美しいフォント。  
※今までは個人のみ無料でしたが、商用も無料になりました。  
フリーフォントのダウンロードは、フォント名の下「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
可読性に優れつつ、流麗なリズムが見出しとして十分なインパクトを与えるフォント。  
※今までは個人のみ無料でしたが、商用も無料になりました。  
フリーフォントのダウンロードは、フォント名の下「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
フリーフォントのダウンロードは、ページ下部の「無料お試し版」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
フリーフォントのダウンロードは、ページ上部の「フリーフォント」から。
...
しねきゃぷしょん  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
サイトでの配布が終了し、再配布が可のため、当方で二次配布させていただきます。

*   [しねきゃぷしょん](//coliss.com/?smd_process_download=1&download_id=24920) (1MB)
...
時刻表っぽいフォント。時刻表独特の細い数字と太い数字も大変読みやすくデザインされています。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
帝都高速度交通営団（現：東京メトロ）の車両番号などに使用されている書体にインスパイアされた数字専用フォント。鋭い角を持つSharp、角が丸められたRoundedの2種類があります。  
フリーフォントのダウンロードは[Releases](https://github.com/ryo-a/TRTA-Numbers-Font/releases)からダウンロードできます。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
静岡県のローカル線「天竜浜名湖鉄道（天浜線）」の駅看板に使用されている手書き文字にインスパイアされたフォント。親近感と温もりのある丸みを帯びた形に、手書きならではの筆運びや筆致の細やかな違いまでも再現されています。  
フリーフォントのダウンロードは、ページ最下部の「ダウンロード」から。
...
*   [sakujitetsudofont.zip](https://coliss.com/?smd_process_download=1&download_id=46885)（14.99KB）
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
鉄道車両の車番に使用する書体としてに鉄道省よってデザインされ、さまざまな鉄道会社の車番用フォントとして採用されている「国鉄車番書体」を再現したフォント。  
シリーズとして、[ウソ電フォント - Kobe](https://soft.2pd.jp/fonts/usoden-kobe/)、[ウソ電フォント - HS](https://soft.2pd.jp/fonts/usoden-hs/)、[ウソ電フォント - HK](https://soft.2pd.jp/fonts/usoden-hk/)、[ウソ電フォント - NK](https://soft.2pd.jp/fonts/usoden-nk/)もあります。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
西日本方向幕ロゴ  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「[西日本方向幕ロゴ　限定公開](http://makufont.dip.jp/memo/)」で配布が終了し、再配布が可のため、当方で二次配布させていただきます。

*   [西日本方向幕ロゴ フォントのダウンロード](//coliss.com/?smd_process_download=1&download_id=24923) (183KB)
...
※現在、事情により一時公開を休止中。  
フリーフォントのダウンロードは、フォント名の横「ダウンロード」から。
...
一時的に仮サイトになってしまったため、作者許諾の元、再頒布します。

*   [GDhwGoJA.zip](https://coliss.com/?smd_process_download=1&download_id=56436) (491KB)
...
個人利用は無料だと思いますが、商用の場合はお問い合わせください。  
2022/3: アップデート。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可（商用は要連絡）同人誌や各種印刷物なども可。  
伊香保温泉の情緒溢れる懐かしい雰囲気に触発されてデザインされたレトロ系ひらがなフォント。  
フリーフォントのダウンロードは、ページ上部の「Download」から。
...
個人・商用サイトで無料利用可（商用は要連絡）同人誌や各種印刷物なども可。  
群馬県温泉地フォントシリーズ第2弾。四万温泉の町並みや道中の里山からイメージを得てデザインされたフォント。  
フリーフォントのダウンロードは、ページ上部の「Download」から。
...
個人・商用サイトで無料利用可（商用は要連絡）同人誌や各種印刷物なども可。  
群馬県温泉地フォントシリーズ第3弾。磯部温泉をイメージして、大正・昭和初期のレトロ感漂うひらがなフォント。  
フリーフォントのダウンロードは、ページ上部の「Download」から。
...
個人・商用サイトで無料利用可（商用は要連絡）同人誌や各種印刷物なども可。  
水上温泉をイメージして、ほっこり感満載かつ雑なタッチで表現されたフォント。お品書きや見出し、擬音・擬態語などにもぴったりです。  
フリーフォントのダウンロードは、ページ上部の「Download」から。
...
個人・商用（要連絡）サイトで無料利用可。  
フリーフォントのダウンロードは、ページ上部の「free download」から。
...
*   [ankoku-onryou.zip](https://coliss.com/?smd_process_download=1&download_id=43131) (5.46MB)
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ホラーに加えてレトロ感もある下町の恐怖フォント。  
漢字は、JIS第一・第二水準。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
ライセンスにもとづき、再頒布します。

*   [ankoku-hakidame.zip](https://coliss.com/?smd_process_download=1&download_id=43132) (2.78MB)
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
怨霊・吐き溜でお馴染みの暗黒工房さんから、8年の沈黙を経て、ついに新作のホラー腐肉系日本語フリーフォントがリリースされました。ひらがな・カタカナ・英数記号文字・漢字はJIS第2水準漢字まですべてカバーされており、「髑髏」「閻魔」「蟲」「蜥蜴」などの旧漢字も表示できます。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
ライセンスにもとづき、再頒布します。

*   [ankoku-zonji.zip](https://coliss.com/?smd_process_download=1&download_id=43133) (4.81MB)
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
漢字は、JIS第一水準、IBM拡張。  
フリーフォントのダウンロードは、サイドバー「無料ダウンロード」から。  
2020/10: ver1.5をリリース。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
モフ字・切り絵字のfab工房から、久しぶりの新作フォント。キラッと光る光芒をイメージしたフォントです。フリー版と有料版があり、フリー版には1,686文字が収録されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
『進撃の巨人』第二期オープニングテーマで使用されてるフォントを真似て作られたフォント。  
漢字は、JIS第一水準。  
フリーフォントのダウンロードは、ページ下部の「フォントをダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
海外で見かける日本語の誤字を表示できるジョークフォント。  
キャプチャは「あなたの文字が更に美しく光る、 まるで魔法のような日本語フォント。」と書かれています。  
フリーフォントのダウンロードは、ページ下部の「フォントをダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
軽やかで弾むような、楽しい雰囲気のキュートなPOP体フォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
フリーフォントのダウンロードは、ページ上部の「Downloaded」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
太めのデザインがかわいいフォント。すべての文字が図形的なシェイプで、どんな並べ方でも自然に調和します。常用漢字2136文字まで収録。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
※2021/4/20: 非公開に。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
楷書・行書・草書の三書体がセットになったペン字フォントで、すべて手書きの字を元に作られています。しかも、混植が可能です！  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
完全手書きの凛々しい楷書、すべて手書きされた文字から作成された、力強く、落ち着いたフォント。縦書き横書きのどちらでもきれいに見えるように調整されています。無料版は文字数が少ないだけで、商用利用もできます。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2022/4: v.2にアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
すらすら流れるような筆致で書かれた完全手書きのJIS第一水準の漢字まで対応したフォント。縦書きにも対応しているので、手紙のデザインに使用してもよいですね。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
瀬戸フォント  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
漢字は、JIS第一・第二・第三・第四水準、IBM拡張制覇。Unicodeをつかった顔文字も大体が表示できます。  
今までのフォントで漢字がでないという方は、このフォントで是非一度お試しを！  
配布ページがなくなったため、ライセンスにもとづき再頒布します。

*   [setofont\_v\_6\_20.zip](https://coliss.com/?smd_process_download=1&download_id=43134) (7.57MB)
...
*   [sp-setofont\_v\_6\_20.zip](https://coliss.com/?smd_process_download=1&download_id=43135) (2.84 MB)
*   [sjis\_sp\_setofont\_v\_6\_20.zip](https://coliss.com/?smd_process_download=1&download_id=43136) (2.33MB)
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
書道歴20年以上の作者:藍原彼方氏が作成した、読みやすい手書きフォント。シェア版とフリー版があり、フリー版ではひらがな・カタカナ・英数記号文字・教育漢字が使用できます。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
作者の手書き文字をフォント化。ひらがな・カタカナ・英数記号文字に加え、小学一年生程度で習う漢字も入っています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
エモい感じをイメージした手書き文字っぽいフォント。商用利用時は、作者のTwitterをフォローする必要があります。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
目指せ世界一収録文字数の多いフォント！日本語はもちろん、他のフォントにはない漢字、さまざまな言語の文字が揃った手書き風のガタガタしたフォントです。  
フリーフォントのダウンロードは、[GitHub](https://github.com/XimcoYuzuriha/Xim_Sans/tree/main/ver_01_62)から。  
2023/9: 最終版となるVer1.62を公開。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
お医者さんからもらった診断書の文字が衝撃的だったから参考にして作成されたフォント。  
フリーフォントのダウンロードは、ページ下部の「こちらからダウンロードできます」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
実際に一文字ずつ手書きして作成されたフォント。JIS第一・第二・第三水準の漢字完備、第四水準も一部対応。約13,500文字を収録。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2023/1: バージョンアップ。
...
個人サイトで無料利用可。同人誌や各種印刷物なども可。  
一文字ずつ手書きされた、直打ちでも手書き感が出るよう配慮されたフォント。インク溜まりと癖のある丸さで、エモかわいいを目指したフォントです。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2024/4: ver.2.03に大型アップデート。
...
ぎゃーてーるみねっせんす  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
蛍光ペンの書き味が楽しい和文手書きフォント。般若心経も入力できます。  
漢字は、JIS第一/第二水準6,355字、IBM拡張を含む約6,900文字。  
2022/2: アップデート  
2022/3: サイトでの配布が終了し、再配布が可のため、当方で二次配布させていただきます。

*   [ぎゃーてーるみねっせんす TTF](https://coliss.com/?smd_process_download=1&download_id=43062) (3.3MB)
*   [ぎゃーてーるみねっせんす OTF](https://coliss.com/?smd_process_download=1&download_id=43063) (3.5MB)
...
じゆうちょうフォント  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ぎゃーてーシリーズ、こちらは少し太めの丸文字風手書きフォント。温かみのあるゴシック体がいい感じ。  
漢字は、JIS第一/第二水準6,355字、IBM拡張を含む約6,900文字。  
フリーフォントのダウンロードは、フォント名の下「ダウンロード」から。  
2022/2: アップデート  
2022/3: サイトでの配布が終了し、再配布が可のため、当方で二次配布させていただきます。

*   [じゆうちょうフォント TTF](https://coliss.com/?smd_process_download=1&download_id=43066) (2.2MB)
*   [じゆうちょうフォント OTF](https://coliss.com/?smd_process_download=1&download_id=43067) (2.6MB)
...
個人・商用サイトで無料利用可（商用は要連絡）。同人誌や各種印刷物なども可。  
少し丸みを帯びた、ほんわかした手書きフォント。JIS第一～第四水準までの漢字が揃っており、絵文字もたくさん使用できます。「（つちよし）」も出ます！  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
2022/11: ver.1.01にアップデート
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「雑」がウリの手書きフォント。ひらがな・カタカナ・漢字をはじめ、さまざまな言語の文字を含め、34,279文字が収録されています。太字版もリリースされました。  
フリーフォントのダウンロードは、ページ上部のフォント名から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
さなフォン リニューアルの第2弾、手書きのフォント「さなフォン」です。ひらなが・カタカナ・英数記号文字、さらに漢字はJIS第一・第二水準、IBM拡張までサポートされており、ギリシャ文字やキリル文字も揃っています。ライセンスが変わり、無料版は商用時に要クレジットで、有償版はノンクレジットでUnicode版（かなりの数のラテン拡張や記号）となっています。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」でBOOTHから。  
2023/9: 文字追加、誤字修正。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
あんずもじが2020年にリニューアルしました。シフトJIS漢字コード表に含まれている漢字はすべて対応しています。  
フリーフォントのダウンロードは、サイドバーの「フォント」をクリックして、移動したページ下部のフォント名をクリック。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
手書き文字をそのまま落とし込んだ、手書きフォント。第一・第二水準漢字も揃っており、ギリシャ文字やロシア文字も揃っています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人サイトで無料利用可。同人誌や各種印刷物なども可。  
一文字ずつ手書きされ、直打ちでも手書き感が出せるフォント。漢字もかなりの数がサポートされています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2023/7: v.2.01に大型アップデート。

日本語のフリーフォント: 手書き風は、他にもたくさんあります！

![毛筆・筆文字、ペン字、マジック、手書きの日本語フリーフォント 総まとめ](data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)

![毛筆・筆文字、ペン字、マジック、手書きの日本語フリーフォント 総まとめ](data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)

![毛筆・筆文字、ペン字、マジック、手書きの日本語フリーフォント 総まとめ](//coliss.com/wp-content/uploads-00/handwriting-japanese-freefont@2x.png.png)

[商用利用無料！ 毛筆・筆文字、ペン字、マジック、手書きの日本語フリーフォント 総まとめ](https://coliss.com/articles/freebies/handwriting-japanese-free-fonts.html)

## 日本語のフリーフォント: 毛筆・楷書・草書
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
動画・同人誌・年賀状などあらゆる創作の場面を想定して作られたシンプルな手書き毛筆フォント。教育漢字のほか、創作に使いそうな漢字も含まれています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
笹の葉のような筆画と、流れるようなイメージから「ささぶね」と命名されました筆文字POPフォント。ひらがな・カタカナ・英数記号文字、漢字はJIS第一・第二水準のおよそ7,000文字が揃っています。無料版は文字数が少ないだけで、商用利用もできます。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2023/10: 誤字を修正。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
居酒屋のメニュー風の字を目指してすべて手書きされたフォント。略字・俗字・異体字で書かれている漢字が数多くあります。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2022/5: 利用規約変更、無料版の埋め込み利用が可能に。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
すべて手書きされた文字から作成された、力強く、落ち着いたフォント。縦書き横書きのどちらでもきれいに見えるように調整されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
一字一句手書きされた筆文字フォント。商用時は要事前連絡。  
フリーフォントのダウンロードは、ページの最下部「藍原筆文字楷書のダウンロード」から。  
2022/11: ver.3.05にアップデート
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
漢字は、JIS第一水準。  
フリーフォントのダウンロードは、ページ下部の「フリーフォントのダウンロード」から。
...
花鳥風月  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
※サイト閉鎖、[web.archive.org](https://web.archive.org/web/20170725100839/http://www.geocities.jp/s318shunkasyuto/down/download.html)からダウンロードはできます。
...
日本語のフリーフォント: 毛筆・楷書・草書は、他にもたくさんあります！
...
個人・商用サイトで無料利用可（商用は要連絡）同人誌や各種印刷物なども可。  
「マツコ会議」のロゴの元ネタ（[参照](https://twitter.com/mksdsato/status/1538824801988423680)）になっているフォント。カタカナ・英数記号文字が揃っており、.aiも含まれています。2022/6にOpentype化されました。  
フリーフォントのダウンロードは、ページ下部の「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
昭和の少女向け雑誌のロゴにインスパイアされた、かわいいフォント。ひらがなと一部記号文字が収録されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人で無料利用可、同人誌や各種印刷物なども可。  
アイヌ語表記ができるアイヌフォント。「アシㇼパさん」のような小さな「ㇼ」、それから「セ゚」「ト゚」等といった、アイヌ語表記に必要なグリフで構成されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
読みやすさにこだわり、横組みに適したかなフォント。靜明朝大かなは、横幅が狭い文字種を心持ち広く、全体が大きめに設計されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
読みやすさにこだわり、縦組みに適したかなフォント。全体が小さめに設計され、大きい漢字に小さいひらがな・カタカナが混在することで、心地よいリズムが生まれます。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
タイプデザイナー金井和夫氏の普段使いの文字をベースとした、明朝・行書の複雑なフォルムをもつフォント。オールドなイメージを残しつつも、その概念にとらわれず大仮名に設計してあるので、近代的な組版にも対応するマルチな性格を備えています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
文字の太さと字幅を自由に変化できるバリアブルフォントです。カタカナといくつかの記号文字が収録されており、商用利用の際には作者のXまたはBoothをフォローする必要があります。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
明治～昭和前期のサイン・ポスターの手書き文字を参考にした手書き風の丸ゴシック体。ひらがな以外はZEN丸ゴシックを使用しており、おしゃれでかわいいデザインです。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
直線のみで構成されたぎっしり詰まったフォント。縦書き・横書きの両方に対応しており、どちらでもぎっしり感が楽しめます。ひらなが・カタカナ・英数記号文字・一部の漢字が揃っています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2023/12: 0.91betaにアップデート。リリース当初より漢字がかなり追加されています。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
すべての文字に渦巻がある伊達巻きのようなフォント。ひらなが・カタカナ・英数記号文字・一部の漢字が揃っています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
レトロ、アンティーク風な文字単体でも使いやすいデザインを想定して制作されたフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
クリ○ップのシンプルなカタカナロゴから作ったフォント。カタカナ・英数記号文字が使用できます。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
音符をモチーフにしたかわいいフォント。有料版と無料版があり、無料版はカタカナと一部の記号文字となっています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
コロコロとしたかわいい子パンダをイメージして制作された、ステンシル風のアクセントがポップな印象のフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
点と点を繋ぐ線を引くことで、文字が完成するフォント。直線・曲線だけでなく、ギザギザや点線にしても面白いです。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
一部の筆画を円弧に置き換えるて文字の空間感やリズム感を強調のフォント。ひらがな・カタカナ・英数記号文字が揃っています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
文字の再現性を確保しつつ、画数の間隔に重視、視覚的なバランスを追求したフォント。ひらがな・カタカナ・英数記号文字が揃っています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人サイトで無料利用可。同人誌や各種印刷物なども可。  
ダークファンタジーを意識した、六角形ベースのデザインフォント。カタカナ・英数記号文字が揃っており、商用利用の場合は作者のSNSアカウントをフォローが条件です。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「何でもハートでデコるのが大好きな少女」の丸っこい手書き文字をイメージした手書きフォント。英文、かな文にもたっぷりとハートが入っています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
シュッとしたはらいが特徴の涼しげな雰囲気のフォント。カタカナ・英数文字が収録されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
70-80年代の丸文字に憧れて作成された、あの頃の丸文字をイメージしたフォント。ひらがな・英数記号文字が揃っています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
某剣客格闘ゲームの勝利画面にインスパイアされたひらがなフォント。勝負や尋常や斬など、ほんの少しだけ漢字も含まれています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2023/8: ver.1.26にアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「東光電気株式会社®」が販売していた白熱電球「トウランプ®」のロゴのレタリングにインスパイアされて作ったフォント。漢字なしの無料版とありの有料版があります。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2023/11: ver.1.95にアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
どこか何か足りてない。でも形はイメージできちゃう。そんなワンストローク（一筆書き）なデザインフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2023/11: ver.1.01にアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
あたまは大きく、おしりはすぼんだような、ちょっとかわいらしい頭でっかちなデザインフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2023/11: ver.1.01にアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
遺跡に刻まれてそうな、斜めを使わない、直線と曲線だけで作られたフォント。今後漢字を含めた完全版もリリース予定、とのことです。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
装飾的要素のないシンプルな直線と曲線で構成され、キッチリ・スッキリした印象の文字組みを実現できるかなフォント。無料版では本文用のウェイト4種類が揃っており、さまざまな和文書体と混植しやすいフォントです。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
カタカナをクールに、そして近未来的にデザインした1byteカタカナフォント。ウェイトはかなり太く安定感のあるフォントなので、インパクトを与える見出しに最適です。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
漢字は使えませんが、大人から子どもまで楽しめるかわいフォント。かな・カタカナ・英数記号など502文字収録。  
フリーフォントのダウンロードは、ページちょい下の「フリーダウンロード」から。
...
個人サイトで無料利用可。同人誌や各種印刷物なども可。  
コンビニをイメージした楽しいフォント。から・カタカナ・英数記号のほかに、コンビニで売ってる商品のイラストフォントが300個揃っています。  
フリーフォントのダウンロードは、ページちょい下の「ダウンロード」から。
...
利用にあたっては、常識の範囲内で使えるもんなら好きに使ってください、とのことです。  
漢字は、小学一年生が習うものまで。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。  
2022: 名称・ダウンロード先変更。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
丸ゴシックのふわふわしたフォント。ひらがな・カタカナ・英数字・記号（一部）を収録。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
フラフィーまんまるゴシック  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
手書き風のまんまるなかわいいフォント。ひらがな、カタカナ、半角英数、記号、全角英数が収録されています。  
※サイト閉鎖、[web.archive.org](https://web.archive.org/web/20220515031705/https://nachaco.com/download-font/f-fluffy-gothic/)からダウンロードはできます。
...
フラフィーなちゅらるハート  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
文字に控えめなハートがくっついたかわいいフォント。  
※サイト閉鎖、[web.archive.org](https://web.archive.org/web/20200927172734/https://nachaco.com/download-font/f-fluffy-nh/)からダウンロードはできます。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
千葉県が 2006 年に発表した「ちば」というロゴにインスパイアされたフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
松下電器産業（現・パナソニック）が主にナショナルブランドで使用していた「ナショナル体」にインスパイアされてデザインされたフォント。斜線を極太に強調されているのが特徴です。文字の形は正方形で、縦組み・横組みどちらにも対応。  
漢字は、「明和電気」「電気グルーブ」「株式会社」などが含まれています。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
スマホゲーム「Ingress」をイメージして作成されたフォント。作成した時期にイベントが横須賀で開催されていたので、この名前に。英語は含まれていませんが、[exotic agent](https://plus.google.com/108579498972536247799/posts/Fyp652hQHB7)との混植がオススメとのこと。  
フリーフォントのダウンロードは、ページ下部の「フォントをダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
インパクトのあるレトロポップなひらがなフォント。ノーマルの「めもわーる」と角を四角くした「めもわーる しかく」があります。漢字と組み合わせる時は、「めもわーる しかく」が合わせやすいです。「めもわーる まる」も制作中。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
絵本に合いそうな懐かしい感じのひらがなフォント。丸ゴシックとの相性が非常によく、レトロ感の漂う、使い勝手の良いフォントです。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
Art Gothicにインスパイアされ、踊るようなかわいさと優雅さを目指したかなフォント。日本語なのに、ビクトリアンな雰囲気が演出できます。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
ほのぼのポップ  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ほのぼのした手書き風の袋文字フォント。ひらがな・カタカナ・英数記号文字が含まれています。  
※サイト閉鎖、[web.archive.org](https://web.archive.org/web/20220626083936/https://nonty.net/font/freefont/honobonopop/)からダウンロードはできます。
...
ふぁんしーはーと  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ハートがちりばめられた袋文字フォント。ひらがな・カタカナ・英数記号文字が含まれています。  
※サイト閉鎖、[web.archive.org](https://web.archive.org/web/20220523025756/https://nonty.net/font/freefont/fancy-heart/)からダウンロードはできます。
...
はんでぃはーとねお  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ハートがちりばめられた手書き風フォント。ひらがな・カタカナ・英数記号文字が含まれています。  
※サイト閉鎖、[web.archive.org](https://web.archive.org/web/20211101145850/https://nonty.net/font/freefont/handyheart-neo/)からダウンロードはできます。
...
ふだんぎふぉんと  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
作者が普段書く文字をペンタブで殴り書きしたひらがなフォント。ひらがな・カタカナ・英数記号文字に対応しています。  
※サイト閉鎖、[web.archive.org](https://web.archive.org/web/20220210075304/https://nonty.net/font/freefont/fudangi-font/)からダウンロードはできます。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
万年筆で書かれた、教育漢字・常用漢字・第一水準までの漢字が揃ったフォント。  
2019/1/19: 第二水準漢字・拡張漢字もサポート。  
フリーフォントのダウンロードは、ページ上部の「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
有機的なシルエットのフォントで、繊細なデザインや女性的な雰囲気を加えたい時にぴったりです。無料版はひらがな・カタカナ・漢字1006文字が収録されています。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。  
2023/5: 誤字のアップデート。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ポメラニアンみたいに丸くてゆる〜い感じのデザインで、ちょっと太めの角丸フォントです。現在のところ漢字は少しだけで、小学3年生の教育漢字まで対応予定です。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
2019/3より、配布が再開しました。「しろくまフォント」「ぽめらにあんフォント」の作者様からのフォント。ver.2になり、数字とアルファベットと記号文字が追加されました。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
カタカナ・数字・記号のみで、縦に長くてカクカクしたタイトル向けのフリーフォントです。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
可読性よりもデザイン性を優先して作成された六角形のフォント。ロゴにぴったりで、記号を装飾として使用することもできます。カタカナ・英数記号文字を収録。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「恋する小惑星」のロゴを参考にしてデザインされたフォント。直線的だけど丸みのあるかわいいフォントです。ひらがな・カタカナ・漢字のほか、小惑星を表す天文記号も収録されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
水平・垂直・斜め45度の直線のみで描かれた、ジオメトリックなフォント。ひらなが・英小文字が収録されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ひらがなを図形として捉え、大胆に空間を開けた幾何学的なフォント。ひらがな・記号文字が収録されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
グレイグラフィックスかつての人気フォントが、ゆるふわ丸ゴシテイストに生まれ変わりました。ひらがなのみ。  
フリーフォントのダウンロードは、「ダウンロードはこちら」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
手書きならぬ手描きで作成されたひらがなフォント。キレイな線に見えて、少しだけラフな仕上がりのデザインです。  
フリーフォントのダウンロードは、「ダウンロードはこちら」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
上記「ぽーら」の姉妹フォント。ゴシックと明朝、みたいな雰囲気の違いをお楽しみください。  
フリーフォントのダウンロードは、「ダウンロードはこちら」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「ぽーら」「うらら」のグレイグラフィックスの新作フォント。主張の強さと読みやすさの絶妙なバランス。  
フリーフォントのダウンロードは、「ダウンロードはこちら」から。  
2020/2: フォント名が変わり、カタカナが追加されました。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
グレイグラフィックスの粋を集めた比類なきフォント。カタカナのみ。  
フリーフォントのダウンロードは、「ダウンロードはこちら」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
カタカナのみの1バイトフォント。  
フリーフォントのダウンロードは、フォントを選択してダウンロードアイコンから。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ネズミに噛まれたあのチーズをイメージしたフォント。M+ 1p Blackと重ねて使うと、より読みやすくチーズ感がでます。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
可読性の高い狂字が欲しいときに、ひらがなとカタカナが融合されたフォント。ひらがな表記かカタカナ表記か迷ったときにも使えますね。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「異端仮名」の新書体『怪』。異端仮名に比べて読みやすく、怪しげになっています。可読性を損なうことなく、並行世界の文字や異質な存在のセリフを表現することができます。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
線を省略したり断絶させたり、円形部分を独立させるなどの操作によって美しいまろみを実現したデザインフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
沖縄語表記のための拡張ひらがな「沖縄文字」の明朝体向けフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
読めなさそうで読めるかもしれない、ちょっとクセのある、好事家な人へ送るオリジナルフォントです。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
適当な文字列と見せかけて実は読めるフォントだったら面白いな、というコンセプトで作られたフォント。文字詰めするとエスニック風のデザインになります。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人サイトで無料利用可。同人誌や各種印刷物なども可。  
やさしい雰囲気とかっこいい勢いの2つを取り入れてデザインされたフォント。ひらがな・カタカナ・英数記号文字が収録されており、漢字は収録されていません。  
フリーフォントのダウンロードは、ページ下部の「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ペンギンのようにかわいらしく、インパクトとキュートさを兼ね備えた80年代風の超極太POP体フォント。  
フリーフォントのダウンロードは、ページ下「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
丸ゴシックのような優しい印象で、音符のようにデザインされたかわいいフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人で無料利用可、非営利の同人誌や各種印刷物なども可。  
異世界・ファンタジー小説に合う明朝体をテーマにデザインされたかなフォント。商用版と無料のmini版があり、mini版は文字数に制限があり横書き専用です。  
フリーフォントのダウンロードは、ページ下部の「無料ダウンロード」から。
...
個人で無料利用可、非営利の同人誌や各種印刷物なども可。  
ナナメの線が印象的な直線だけで作られた記号のようなかなフォント。未来的なロゴや異世界風の文字にぴったりです。  
フリーフォントのダウンロードは、ページ下部の「フリーフォントをダウンロード」から。
...
個人で無料利用可。画像投稿サイト、コミケなどの同人誌の利用も無料。  
ネコ耳のような三角形を取り入れたデザインのかわいいフォント。漢字は含まれていないので、太めの丸ゴシックとの組み合わせがオススメです。  
フリーフォントのダウンロードは、ページ下部の「無料ダウンロード」から。
...
個人で無料利用可。画像投稿サイト、コミケなどの同人誌の利用も無料。  
レトロ・かわいい・ゴスロリをイメージして作られたフォント。ロゴタイトルやキャッチフレーズなどの大きなサイズに適しています。  
フリーフォントのダウンロードは、ページ下部の「フリーフォントをダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
「五號明朝活字總數見本　全」にインスパイアされた明朝体の仮名文字フォント。源ノ明朝の漢字グリフとを組み合わせた「[錦源明朝](http://www.akenotsuki.com/eyeben/fonts/kingen.html)」もあります。  
フリーフォントのダウンロードは、ページちょい下「Download」から。  
2021/8: ver.3.004にアップデート
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
横幅をコンパクトにした少しポップなゴシック体の仮名フォント。スマホの小さなスクリーンで、コンパクトに表示させたい時用に。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人サイトで無料利用可。同人誌や各種印刷物なども可。  
ひらがな・カタカナ・英数字のベースラインを漢字に合わせたフォント。英語や数字の混在した日本語文章においても、統一感のある雰囲気を出せます。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
[まろみん](https://fontring.booth.pm/items/1311668)  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
線を省略したり断絶させたり、円形部分を独立させるなどの操作によって美しいまろみを実現したデザインフォント。「ふつう」「みんちょう」の2スタイルが含まれています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
タイトルやコピーで強いインパクトを出すのにぴったりな強い執着心と孤独をモチーフにしたタイトル向けデザインフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人で無料利用可。画像投稿サイト、コミケなどの同人誌の利用も無料。  
ギャル文字風の日本語フォント。ひらがな、カタカナ、英数字が揃っています。  
フリーフォントのダウンロードは、ページ下部の「フォントをダウンロード」から。
...
個人で無料利用可。画像投稿サイト、コミケなどの同人誌の利用も無料。  
ヘボさが魅力的な味のある手書きフォント。  
※サイト閉鎖、[web.archive.org](https://web.archive.org/web/20181105090827/http://www.geocities.jp/hero_tu/font1.htm)からダウンロードはできます。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
冬の空気のような、からっと乾いたニュアンスを持つ走り書きフォント。  
ひらがな・カタカナ・英数記号文字を収録。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
陰陽のように、文字の先端を正円と正円をくり抜いたデザインにしたフォント。綺麗で色気のあるフォントをというテーマで作成されました。  
ひらがな・カタカナ・英数記号文字を収録。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人サイトで無料利用可。同人誌や各種印刷物なども可。  
モンハンライズに出てきたひらがな3文字をもとに、無理矢理作成したフォント。ひらがな・カタカナ・数字のみが収録されています。  
フリーフォントのダウンロードは、ページ下部「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
無料版はひらがな・カタカナ・英数記号文字が収録されており、有料版では漢字が収録されています。  
フリーフォントのダウンロードは、ページ上部の「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
マンガなどのタイトル・見出し用にデザインされたフォント。無料版はひらがな・カタカナ・英数記号文字が収録されています。  
フリーフォントのダウンロードは、ページ上部の「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
マンガなどのタイトル・見出し用にデザインされたフォント。カタカナのみが収録されています。  
フリーフォントのダウンロードは、ページ上部の「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
サン●リーオールドのロゴを参考にデザインされたフォント。カタカナのみですが、横書き・縦書きに対応しています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
デコボコした文字組みと、直線と曲線によるデザインによって描き出された遊び系1byteひらがなフォント。  
フリーフォントのダウンロードは、ページ下部の「フォントダウンロード」から。

## 日本語のフリーフォント: ピクセルフォント・ビットマップ・電卓数字
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
大きな字面と広いフトコロを持った丸ゴシックのピクセルフォント。扱いやすい12ピクセルをベースとしており、かわいいピクセル表現に寄り添うフォントです。ひらがな・カタカナ・英数記号文字に加え、漢字も豊富に揃っています。JIS第1水準漢字2965字、第2水準漢字3390字を収録。  
フリーフォントのダウンロードは、フォント名下の「Download」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ピクセルが形作る曲線美を追求した丸ゴシック体のピクセルフォント。ひらがな・カタカナ・英数記号文字をはじめ、JIS第1水準漢字2965字、第2水準漢字3390字が完全収録されています。  
フリーフォントのダウンロードは、フォント名下の「Download」から。  
2023/7: 商品ラインナップを整理。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
4x4の極小空間にデザインされた、最小のフォント。英数記号文字だけでなく、ひらがな・カタカナも使用できます。さらに、濁点・半濁点にも対応しており、「ばびぶべぼ」「ぱぴぶぺぼ」も可。  
フリーフォントのダウンロードは、ページ最下部の「だうんろーど」から。
...
個人サイトで無料利用可。非営利の同人誌や各種印刷物なども可。  
ファミコンやゲームボーイのような、8‐bitのレトロゲームの雰囲気をもったフォント。一種類の和文書体「もち」に、三種類の欧文書体「きなこ」「あんこ」「よもぎ」が結合されたフォントです。漢字は出現頻度の高い字、学習漢字、画数の少ない字を中心に612文字が収録されています。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
1987年に発売されたシャープのパソコン「X68000」シリーズ用として頒布されたドットフォント15書体が、TrueType形式のフリーフォントとして現代に蘇りました。こちらは再配布可なので、ライセンスにもとづき再頒布します。

*   [khdotfont-20150527.zip](https://coliss.com/?smd_process_download=1&download_id=61460) (10.1MB)
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
8×8ドットの日本語ビットマップフォントで、JIS第一・第二水準漢字をサポート。  
2019/6: 新フォント「美咲ゴシック第2」を追加。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。

ピクセルフォント・ビットマップ・電卓数字は、他にもたくさんあります！

![ピクセルフォント・ビットマップ・電卓数字の日本語フリーフォント 総まとめ](data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)

![ピクセルフォント・ビットマップ・電卓数字の日本語フリーフォント 総まとめ](//coliss.com/wp-content/uploads-00/pixel-japanese-freefont@2x.png)

[ピクセルフォント・ビットマップ・電卓数字の日本語フリーフォント 総まとめ](https://coliss.com/articles/freebies/pixel-japanese-free-fonts.html)

## 日本語のフリーフォント: 外字・象形文字・記号文字
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
読めるか読めないかギリギリにデザインされた英数記号文字のフォント。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
上記の同シリーズの魔方陣文様フォント。呪文を書く時に最適です。  
フリーフォントのダウンロードは、ページ下部の「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ヴォイニッチ文字、オーラベッシュ文字、コプト文字、デザレット文字、ショー文字、ユーエル文字、ドニ文字など、さまざまな人工文字が収録されています。  
フリーフォントのダウンロードは、ページ下部の「download Fairfax HD here」から。
...
ひらがな刻呪ふぉんと  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
Fateの令呪にインスパイアされた、なんちゃって雰囲気フォント。ほかにも中二的な記号がたくさん揃っています。  
作者様からのメッセージ「Fateの創作をされる方などにお使いいただけると嬉しいです」  
フリーフォントのダウンロードは、[Dropbox](https://www.dropbox.com/s/y7sh1omaz6s1sgz/kokuju_font.zip?dl=0)から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
通常では表示できない外字が利用できるようになるフォント。絵文字や記号フォントも数多く揃っています。  
フリーフォントのダウンロードは、サイドバーの「ダウンロード」から。
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
宋代以降の各王朝、また異民族王朝の金において官印に用いられた小篆である九畳篆を模したフォント。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
...
秀真文字  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
古代日本の神代文字、秀真文字（ホツマ文字）をフォント化。

配布が終了し、再配布が可のため、当方で二次配布させていただきます。

*   [秀真文字 フォントのダウンロード](//coliss.com/?smd_process_download=1&download_id=24931) (476KB)
...
出雲文字  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
古代日本の神代文字、出雲文字（イヅモ文字）をフォント化。

配布が終了し、再配布が可のため、当方で二次配布させていただきます。

*   [出雲文字 フォントのダウンロード](//coliss.com/?smd_process_download=1&download_id=24934) (502KB)
...
阿比留草文字  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
古代日本の神代文字、阿比留草文字（アヒルクサ文字）をフォント化。

配布が終了し、再配布が可のため、当方で二次配布させていただきます。

*   [阿比留草文字 フォントのダウンロード](//coliss.com/?smd_process_download=1&download_id=24936) (455KB)
...
漢字を甲骨・金文・古文・籀文・篆文などの古代文字で表示できます。  
フリーフォントのダウンロードは、ページちょい下の「ダウンロード」から。
...
コード譜フォント  
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
ギタースコアとして使用するコード譜をフォント化、テキスト入力の感覚でコード譜を作成できます。Webフォントにも対応。  
配布ページがなくなったため、ライセンスにもとづき再頒布します。

*   [GIGI\_Guitar\_Score\_Chord\_Font\_Free.zip](https://coliss.com/?smd_process_download=1&download_id=56295) (126KB)
...
個人・商用サイトで無料利用可。同人誌や各種印刷物なども可。  
こかげの窓からまた面白いフォントがリリースされました。日本の道路標識に基づいて作ったフォントで、部品を組み合わせてさまざまな標識を作成できます。例えば、一方通行だと「@(●↑)」、転回禁止だと「@(○\\@転)」と書きます。  
フリーフォントのダウンロードは、サイドバーの「無料ダウンロード」から。
